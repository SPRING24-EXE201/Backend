        ...
        html_body = f"""<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
          <div style="margin:50px auto;width:70%;padding:20px 0">
            <div style="border-bottom:1px solid #eee">
              <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">iBox</a>
            </div>
            <p style="font-size:1.1em">Xin chào,</p>
            <p>Cảm ơn bạn đã tin dùng iBox. Hãy sử dụng OTP sau để hoàn thành quá trình {action} của bạn. OTP của bạn có hiệu lực trong {SystemConstants.otp_timeout / 60} phút</p>
